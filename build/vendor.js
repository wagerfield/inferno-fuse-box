...
___scope___.file("dist/inferno.node.js", function(exports, require, module, __filename, __dirname){
...
function cloneVNode(vNodeToClone, props) {
    ...
    if (isArray(vNodeToClone)) {
        ...
        if (flags & 28 /* Component */) {
            newVNode = createVNode(flags, vNodeToClone.type, assign({}, vNodeToClone.props, props), null, events, key, ref, true);
            ...
            newVNode = createVNode(flags, vNodeToClone.type, assign({}, vNodeToClone.props, props), children, events, key, ref, !children);
        }
...
return ___scope___.entry = "dist/inferno.node.js";
});
